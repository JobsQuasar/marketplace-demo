...
const createStripeCheckoutSession = async (event, context, callback) => {
  ...
  try {
    ...
    const checkoutSession = await stripe.checkout.sessions.create({
      ...
      success_url: `${process.env.STELACE_INSTANT_WEBSITE_URL}/a/${assetId}?payment-success=true&transactionId=${transactionId}`,
      cancel_url: `${process.env.STELACE_INSTANT_WEBSITE_URL}/a/${assetId}?payment-cancel=true`,
